...
sealed class ObjectDetailedState with _$ObjectDetailedState {
  const factory ObjectDetailedState.data(ObjectEntity object) = ObjectDetailedStateData;
  const factory ObjectDetailedState.error([String? message]) = ObjectDetailedStateError;
